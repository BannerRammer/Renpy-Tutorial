...
define config.name = _("Lorenzo's Good Tutorial Game")
...
define build.name = "LorenzosGoodTutorialGame"
...
define config.save_directory = "LorenzosGoodTutorialGame-1526111193"
